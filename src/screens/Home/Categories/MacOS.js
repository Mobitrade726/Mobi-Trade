...
const MacOS = ({navigation}) => {
  const budgetOptions = [
    {
      label: 'Under ₹10,000',
      image:
        'https://i.postimg.cc/8PjGrz04/Category-Card-01-3.png',
    },
    {
      label: '₹10,000 - ₹20,000',
      image:
        'https://i.postimg.cc/268MRHpG/Category-Card-02-2.png',
    },
    {
      label: '₹20,000 - ₹30,000',
      image:
        'https://i.postimg.cc/Wzq9TC5G/Category-Card-03-1.png',
    },
    {
      label: 'Above ₹30,000',
      image:
        'https://i.postimg.cc/ncvym91v/Category-Card-4-1.png',
    },
  ];
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView>
        ...
        <Image
          ...
          source={{
            uri: 'https://i.postimg.cc/sDZPXpsJ/Shopping-Immersive-Header-with-Image-and-CTA-2.png',
          }}
        />
        ...
        <View style={styles.sectionHeader}>
          <Text style={styles.sectionTitle}>Top Macbooks</Text>
          <TouchableOpacity
            onPress={() => navigation.navigate('TopMacbooks')}>
            <Ionicons
              marginRight={12}
