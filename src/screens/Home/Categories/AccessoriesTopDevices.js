...
const AccessoriesTopDevices = ({navigation}) => {
  const budgetOptions = [
    {
      label: 'Under ₹10,000',
      image:
        'https://i.postimg.cc/Bbt0FGww/A-young-adult-sitting-in-a-sleek-gaming-chair-focused-on-a-video-game-with-a-high-end-gaming-consol.png',
    },
    {
      label: '₹10,000 - ₹20,000',
      image:
        'https://i.postimg.cc/ncdSwPhp/A-modern-office-desk-with-a-sleek-laptop-an-open-notepad-and-a-steaming-coffee-cup.png',
    },
    {
      label: '₹20,000 - ₹30,000',
      image:
        'https://i.postimg.cc/kM2kPCLD/A-person-painting-on-a-canvas-in-a-bright-studio-filled-with-colorful-art-supplies.png',
    },
    {
      label: 'Above ₹30,000',
      image:
  ...
  const PRODUCTSFILTER = [
    {
      id: '1',
      image: 'https://i.postimg.cc/SxD43Y3W/Depth-5-Frame-1.png',
      name: 'OnePlus 9',
      color: 'Black',
      price: '₹20,999',
      originalPrice: '₹24,999',
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView>
        ...
        <View style={styles.header}>
          ...
          <View>
            <Text style={styles.headerTitle}>Top Devices</Text>
          </View>
...
export default AccessoriesTopDevices;
