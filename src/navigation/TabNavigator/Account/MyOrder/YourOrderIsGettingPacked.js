    ...
    <SafeAreaView style={{flex: 1, backgroundColor: '#fff'}}>
      ...
      <ScrollView contentContainerStyle={{padding: 16}}>
        ...
        <TouchableOpacity style={styles.trackBanner}>
          <View style={{flex: 1}}>
            <Text style={styles.trackText}>Your order is getting packed</Text>
        ...
        <View style={{flexDirection: 'row', justifyContent: 'center'}}>
          ...
          <TouchableOpacity
            ...
            <Text style={[styles.buttonText, {color: 'red'}]}>Cancle</Text>
          </TouchableOpacity>
        </View>
...
export default YourOrderIsGettingPacked;
